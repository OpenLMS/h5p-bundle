...
namespace OpenLMS\H5PBundle\Editor;
...
use OpenLMS\H5PBundle\Event\LibraryFileEvent;
...
class EditorStorage implements \H5peditorStorage
{
    ...
    {
        return $this->entityManager->getRepository('H5PBundle:LibrariesLanguages')->findForLibrary($machineName, $majorVersion, $minorVersion, $languageCode);
    }
    ...
    public function getLibraries($libraries = NULL)
    {
        ...
        $libraries = [];
        $librariesResult = $this->entityManager->getRepository('H5PBundle:Library')->findAllRunnableWithSemantics();
    ...
    private function getLibrariesWithDetails($libraries, $canCreateRestricted)
    {
        ...
        foreach ($libraries as $library) {
            $details = $this->entityManager->getRepository('H5PBundle:Library')->findHasSemantics($library->name, $library->majorVersion, $library->minorVersion);
            if ($details) {
