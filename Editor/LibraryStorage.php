...
class LibraryStorage
{
    ...
    public function storeLibraryData($library, $parameters, Content $content = null)
    {
        ...
        $libraryData['libraryId'] = $this->entityManager->getRepository('H5PBundle:Library')->findIdBy($libraryData['machineName'], $libraryData['majorVersion'], $libraryData['minorVersion']);
